...
const STATIC_CACHE  = "ntpc-static-v1";
const DATA_CACHE    = "ntpc-data-v1";
const ASSET_CACHE   = "ntpc-assets-v1";
...
self.addEventListener("fetch", event => {
  ...
  const isApiSession = ["/rrb-ntpc/exam/start", "/rrb-ntpc/exam/sync", "/rrb-ntpc/exam/submit",
