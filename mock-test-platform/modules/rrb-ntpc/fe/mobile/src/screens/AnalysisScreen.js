  ...
  return (
    <SafeAreaView style={styles.shell}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={[styles.hdrBtn, styles.hdrBtnHome]} onPress={() => navigation.replace(backRoute || "RRBNTPCHome")}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={[styles.fBtn, styles.fBtnBlue]} onPress={() => navigation.replace(backRoute || "RRBNTPCHome")}>
