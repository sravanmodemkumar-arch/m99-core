/**
 * CDN delta sync — downloads only changed JSON files.
 *
 * manifest.json shape:
 * {
 *   "files": [
 *     { "key": "exam_catalogue", "url": "https://cdn.../exam_catalogue.json", "hash": "abc123" },
 *     { "key": "bundle:exam_abc","url": "https://cdn.../bundles/exam_abc.json","hash": "def456" }
 *   ]
 * }
 */
