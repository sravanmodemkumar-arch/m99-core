  ...
  return (
    <SafeAreaView style={styles.shell}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.hdrBtn} onPress={() => navigation.replace(backRoute || "RRBGroupDHome")}>
          <Text style={styles.hdrBtnTxt}>← Home</Text>
        </TouchableOpacity>
        <Text style={styles.hdrTitle} numberOfLines={1}>{label}</Text>
        <TouchableOpacity style={[styles.hdrBtn, styles.hdrBtnPurple]} onPress={() => navigation.navigate("Analysis", route.params)}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={[styles.fBtn, styles.fBtnOutline]} onPress={() => navigation.replace(backRoute || "RRBGroupDHome")}>
